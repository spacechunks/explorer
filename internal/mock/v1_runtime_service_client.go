...
func (_m *MockV1RuntimeServiceClient) GetContainerEvents(ctx context.Context, in *v1.GetEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.ContainerEventResponse], error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_c *MockV1RuntimeServiceClient_GetContainerEvents_Call) Return(_a0 grpc.ServerStreamingClient[v1.ContainerEventResponse], _a1 error) *MockV1RuntimeServiceClient_GetContainerEvents_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockV1RuntimeServiceClient_GetContainerEvents_Call) RunAndReturn(run func(context.Context, *v1.GetEventsRequest, ...grpc.CallOption) (grpc.ServerStreamingClient[v1.ContainerEventResponse], error)) *MockV1RuntimeServiceClient_GetContainerEvents_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockV1RuntimeServiceClient) StreamContainerStats(ctx context.Context, in *v1.StreamContainerStatsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamContainerStatsResponse], error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockV1RuntimeServiceClient_StreamContainerStats_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StreamContainerStats'
type MockV1RuntimeServiceClient_StreamContainerStats_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockV1RuntimeServiceClient_Expecter) StreamContainerStats(ctx interface{}, in interface{}, opts ...interface{}) *MockV1RuntimeServiceClient_StreamContainerStats_Call {
	return &MockV1RuntimeServiceClient_StreamContainerStats_Call{Call: _e.mock.On("StreamContainerStats",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockV1RuntimeServiceClient_StreamContainerStats_Call) Run(run func(ctx context.Context, in *v1.StreamContainerStatsRequest, opts ...grpc.CallOption)) *MockV1RuntimeServiceClient_StreamContainerStats_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockV1RuntimeServiceClient_StreamContainerStats_Call) Return(_a0 grpc.ServerStreamingClient[v1.StreamContainerStatsResponse], _a1 error) *MockV1RuntimeServiceClient_StreamContainerStats_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockV1RuntimeServiceClient_StreamContainerStats_Call) RunAndReturn(run func(context.Context, *v1.StreamContainerStatsRequest, ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamContainerStatsResponse], error)) *MockV1RuntimeServiceClient_StreamContainerStats_Call {
	_c.Call.Return(run)
	return _c
}

// StreamContainers provides a mock function with given fields: ctx, in, opts
func (_m *MockV1RuntimeServiceClient) StreamContainers(ctx context.Context, in *v1.StreamContainersRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamContainersResponse], error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockV1RuntimeServiceClient_StreamContainers_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StreamContainers'
type MockV1RuntimeServiceClient_StreamContainers_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockV1RuntimeServiceClient_Expecter) StreamContainers(ctx interface{}, in interface{}, opts ...interface{}) *MockV1RuntimeServiceClient_StreamContainers_Call {
	return &MockV1RuntimeServiceClient_StreamContainers_Call{Call: _e.mock.On("StreamContainers",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockV1RuntimeServiceClient_StreamContainers_Call) Run(run func(ctx context.Context, in *v1.StreamContainersRequest, opts ...grpc.CallOption)) *MockV1RuntimeServiceClient_StreamContainers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockV1RuntimeServiceClient_StreamContainers_Call) Return(_a0 grpc.ServerStreamingClient[v1.StreamContainersResponse], _a1 error) *MockV1RuntimeServiceClient_StreamContainers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockV1RuntimeServiceClient_StreamContainers_Call) RunAndReturn(run func(context.Context, *v1.StreamContainersRequest, ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamContainersResponse], error)) *MockV1RuntimeServiceClient_StreamContainers_Call {
	_c.Call.Return(run)
	return _c
}

// StreamPodSandboxMetrics provides a mock function with given fields: ctx, in, opts
func (_m *MockV1RuntimeServiceClient) StreamPodSandboxMetrics(ctx context.Context, in *v1.StreamPodSandboxMetricsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamPodSandboxMetricsResponse], error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockV1RuntimeServiceClient_StreamPodSandboxMetrics_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StreamPodSandboxMetrics'
type MockV1RuntimeServiceClient_StreamPodSandboxMetrics_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockV1RuntimeServiceClient_Expecter) StreamPodSandboxMetrics(ctx interface{}, in interface{}, opts ...interface{}) *MockV1RuntimeServiceClient_StreamPodSandboxMetrics_Call {
	return &MockV1RuntimeServiceClient_StreamPodSandboxMetrics_Call{Call: _e.mock.On("StreamPodSandboxMetrics",
		append([]interface{}{ctx, in}, opts...)...)}
}
...
func (_c *MockV1RuntimeServiceClient_StreamPodSandboxMetrics_Call) Return(_a0 grpc.ServerStreamingClient[v1.StreamPodSandboxMetricsResponse], _a1 error) *MockV1RuntimeServiceClient_StreamPodSandboxMetrics_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockV1RuntimeServiceClient_StreamPodSandboxMetrics_Call) RunAndReturn(run func(context.Context, *v1.StreamPodSandboxMetricsRequest, ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamPodSandboxMetricsResponse], error)) *MockV1RuntimeServiceClient_StreamPodSandboxMetrics_Call {
	_c.Call.Return(run)
	return _c
}

// StreamPodSandboxStats provides a mock function with given fields: ctx, in, opts
func (_m *MockV1RuntimeServiceClient) StreamPodSandboxStats(ctx context.Context, in *v1.StreamPodSandboxStatsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamPodSandboxStatsResponse], error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockV1RuntimeServiceClient_StreamPodSandboxStats_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StreamPodSandboxStats'
type MockV1RuntimeServiceClient_StreamPodSandboxStats_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockV1RuntimeServiceClient_Expecter) StreamPodSandboxStats(ctx interface{}, in interface{}, opts ...interface{}) *MockV1RuntimeServiceClient_StreamPodSandboxStats_Call {
	return &MockV1RuntimeServiceClient_StreamPodSandboxStats_Call{Call: _e.mock.On("StreamPodSandboxStats",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockV1RuntimeServiceClient_StreamPodSandboxStats_Call) Run(run func(ctx context.Context, in *v1.StreamPodSandboxStatsRequest, opts ...grpc.CallOption)) *MockV1RuntimeServiceClient_StreamPodSandboxStats_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockV1RuntimeServiceClient_StreamPodSandboxStats_Call) Return(_a0 grpc.ServerStreamingClient[v1.StreamPodSandboxStatsResponse], _a1 error) *MockV1RuntimeServiceClient_StreamPodSandboxStats_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockV1RuntimeServiceClient_StreamPodSandboxStats_Call) RunAndReturn(run func(context.Context, *v1.StreamPodSandboxStatsRequest, ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamPodSandboxStatsResponse], error)) *MockV1RuntimeServiceClient_StreamPodSandboxStats_Call {
	_c.Call.Return(run)
	return _c
}

// StreamPodSandboxes provides a mock function with given fields: ctx, in, opts
func (_m *MockV1RuntimeServiceClient) StreamPodSandboxes(ctx context.Context, in *v1.StreamPodSandboxesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamPodSandboxesResponse], error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockV1RuntimeServiceClient_StreamPodSandboxes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StreamPodSandboxes'
type MockV1RuntimeServiceClient_StreamPodSandboxes_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockV1RuntimeServiceClient_Expecter) StreamPodSandboxes(ctx interface{}, in interface{}, opts ...interface{}) *MockV1RuntimeServiceClient_StreamPodSandboxes_Call {
	return &MockV1RuntimeServiceClient_StreamPodSandboxes_Call{Call: _e.mock.On("StreamPodSandboxes",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockV1RuntimeServiceClient_StreamPodSandboxes_Call) Run(run func(ctx context.Context, in *v1.StreamPodSandboxesRequest, opts ...grpc.CallOption)) *MockV1RuntimeServiceClient_StreamPodSandboxes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockV1RuntimeServiceClient_StreamPodSandboxes_Call) Return(_a0 grpc.ServerStreamingClient[v1.StreamPodSandboxesResponse], _a1 error) *MockV1RuntimeServiceClient_StreamPodSandboxes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockV1RuntimeServiceClient_StreamPodSandboxes_Call) RunAndReturn(run func(context.Context, *v1.StreamPodSandboxesRequest, ...grpc.CallOption) (grpc.ServerStreamingClient[v1.StreamPodSandboxesResponse], error)) *MockV1RuntimeServiceClient_StreamPodSandboxes_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockV1RuntimeServiceClient) UpdatePodSandboxResources(ctx context.Context, in *v1.UpdatePodSandboxResourcesRequest, opts ...grpc.CallOption) (*v1.UpdatePodSandboxResourcesResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdatePodSandboxResources'
type MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call struct {
	*mock.Call
}
...
//   - opts ...grpc.CallOption
func (_e *MockV1RuntimeServiceClient_Expecter) UpdatePodSandboxResources(ctx interface{}, in interface{}, opts ...interface{}) *MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call {
	return &MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call{Call: _e.mock.On("UpdatePodSandboxResources",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call) Run(run func(ctx context.Context, in *v1.UpdatePodSandboxResourcesRequest, opts ...grpc.CallOption)) *MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
...
func (_c *MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call) Return(_a0 *v1.UpdatePodSandboxResourcesResponse, _a1 error) *MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call) RunAndReturn(run func(context.Context, *v1.UpdatePodSandboxResourcesRequest, ...grpc.CallOption) (*v1.UpdatePodSandboxResourcesResponse, error)) *MockV1RuntimeServiceClient_UpdatePodSandboxResources_Call {
	_c.Call.Return(run)
	return _c
}
